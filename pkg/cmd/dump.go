...
func init() {
	dumpCmd.Flags().StringVarP(&dumpPathFlag, "path", "p", "", "The folder path where the dump file should be saved. Brazn Tasks will use the configured root path or the binary location if the flag is not provided.")
