...
//
// THIS TEST FAILS if Task.Reactions loses omitempty / nullable (BRA-1363):
// AutoPatch then merges null reactions into the PUT and Huma answers 422.
...
//
// FAILS if Subscription.EntityType loses its Huma Schema override (BRA-1363):
// the wire form is the string "task" while the schema would publish integer.
